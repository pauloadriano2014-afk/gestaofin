...
import { X, Check, Zap, Crown, ShieldCheck, Loader2, FileText, Briefcase, TrendingUp, Mic } from "lucide-react"; 
...
export function PremiumModal({ isOpen, onClose }: PremiumModalProps) {
  ...
  return (
    // Z-INDEX 99999 GARANTIDO
    <div className="fixed inset-0 z-[99999] flex items-center justify-center bg-black/90 backdrop-blur-sm p-4 overflow-y-auto md:overflow-hidden">
      
      {/* Container Principal */}
      <div className="bg-zinc-950 border border-zinc-800 w-full max-w-[95vw] md:max-w-4xl max-h-[90vh] md:max-h-[85vh] overflow-y-auto md:overflow-hidden rounded-3xl relative shadow-2xl flex flex-col md:flex-row animate-in fade-in zoom-in duration-300">
        ...
        <div className="w-full md:w-1/2 bg-zinc-950 p-6 md:p-8 flex flex-col">
          ...
          {/* AJUSTE AQUI: pt-4 para a etiqueta não cortar e max-h ajustado */}
          <div className="flex-1 space-y-3 mb-6 overflow-y-auto max-h-[300px] md:max-h-[400px] custom-scrollbar px-1 pt-4">
            ...
            >
              {selectedPlan === 'annual' && <div className="absolute -top-3 right-4 bg-blue-500 text-white text-[10px] font-bold px-2 py-0.5 rounded-full shadow-lg shadow-blue-500/20 z-10">MAIS VENDIDO</div>}
            ...
            <div 
              ...
              className={`relative cursor-pointer p-4 rounded-xl border-2 transition-all ${selectedPlan === 'semiannual' ? 'border-blue-500 bg-blue-500/5' : 'border-zinc-800 hover:border-zinc-700 bg-zinc-900'}`}
            >
              <div className="flex justify-between items-center">
                <div>
            ...
            <div 
              ...
              className={`relative cursor-pointer p-4 rounded-xl border-2 transition-all ${selectedPlan === 'quarterly' ? 'border-blue-500 bg-blue-500/5' : 'border-zinc-800 hover:border-zinc-700 bg-zinc-900'}`}
            >
              <div className="flex justify-between items-center">
                <div>
            ...
            <div 
              ...
              className={`relative cursor-pointer p-4 rounded-xl border-2 transition-all ${selectedPlan === 'monthly' ? 'border-blue-500 bg-blue-500/5' : 'border-zinc-800 hover:border-zinc-700 bg-zinc-900'}`}
            >
              <div className="flex justify-between items-center">
                <div>
